        ...
        {loading
          ? (
            <div className="loading-dog">
              <img src="/doganimation.gif" width="250" />
              <br />
              <br />
              <br />
          ...
          : (
            <div>
              <h4 className="pack-title">
                Este pack te va a rendir
                <u>1</u>
                {' '}
                mes
                <br />
                y contiene los siguiente productos:
              </h4>
              <Container>
...
{price}
      ...
      <ActionButtons showPrev prevAction={prev} nextActive={!loading} nextAction={next} />

...
import { MUTATION_NEWSLETTER } from '../../queries/newsletter';
import { useMutation } from '@apollo/client';

export default function Footer() {
  const [createNewsletter, { loading, data }] = useMutation(MUTATION_NEWSLETTER);
      ...
      <div className="py-6 bg-gray-200 text-muted">
        <div className="container">
          <div className="row">
            ...
            <div className="mb-5 mb-lg-0 col-lg-4 newsletter-group">
              <div className="font-weight-bold text-uppercase text-dark mb-3">
                NOVEDADES
              </div>
              ...
              {data ? (<p>Gracias por subirte a esta movida :)</p>) : (<>
                ...
                validationSchema={Yup.object().shape({
                  email: Yup.string()
                    ...
                    .required('Ingresá un e-mail válido'),
                })}
                onSubmit={({ email }) => {
                  createNewsletter({
                    variables: {
                ...
                {({ errors, touched }) => (
                  <Form>
                    ...
                    <div className="input-group mb-3">
                      <Field name="email" type="email" className="bg-transparent border-dark border-right-0 form-control" />
                      <div className="input-group-append">
                        <button type="submit" className="btn-newsletter btn-outline-dark border-left-0 btn btn-deoco">></button>
                      </div>
                    </div>
                  </Form>
                )}
